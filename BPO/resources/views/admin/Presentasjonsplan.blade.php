    ...
    <div class="container">
        <div class="row">
            ...
            @if($finnes3 == true)
                ...
                {!! Form::close() !!}
            @endif
            {!! Form::open(['action' => ['PresentasjonController@create'], 'method' => 'POST', 'class' => 'd-inline-block margin-fix', 'style' => ' padding-left:0']) !!}
        ...
        <form class="row form-group" style="margin-top:0.5em;">
            ...
            <div style="padding:0;" class="col-3 margin-fix" >
                <input type="submit" value="Antall Rom" class="btn btn-primary">
            </div>
        </form>
