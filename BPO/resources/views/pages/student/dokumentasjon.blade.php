...
@section('content')
    <div class="jumbotron">
        <div class="container">
            ...
            <i class="fa fa-dot-circle-o" aria-hidden="true" style="color:black;"></i><a target='_blank' href="{{ asset('files/dokumentasjonsstandard-2.pdf')}}"> Dokumentasjonsforslag for bachelorprosjekter (kun veiledende) <i class="fas fa-file-pdf" style="color: red"aria-hidden="true"></i></a>
                </br>
