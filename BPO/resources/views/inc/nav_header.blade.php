        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                <li class="nav-item active">
                    <a style="padding-left: 0;" class="nav-link" href="/studenter" class="card-link"> Studenter</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/sensorer" class="card-link">Sensorer</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/oppdragsgivere" class="card-link">Oppdragsgivere</a>
                </li>
            </ul>
        </div>
    </nav>
